...
public class Test {
    ...
    private static void casoDePrueba2() {
        ...
        Compania Compania2 = new Compania("Mi Compañía");
        boolean areaAgregada = Compania2.agregarArea(1);
        boolean oficinaAgregada = Compania2.agregarOficina(101); // Oficina 101
        if (oficinaAgregada) {
